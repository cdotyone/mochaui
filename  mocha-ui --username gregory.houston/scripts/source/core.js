...
Todo from Evgeni Stebaev
1. Dock controls can be disabled (need this for my project)
2. onResize should be fired after maximize/restore
3. Maximized window cannot be dragged/resized
4. Maximized window zIndex set to 10000 (need this for my project as well)
5. new Window() now returns window object
6. With effects disabled maximizing caused an error	
